...
- **[Autonomy Guards Reference](guides/autonomy-guards-reference.md):** Guard-by-guard behavior, switches, and risk notes.
...
- [User Guides](#user-guides)
  ...
  - [Autonomy Guards Reference](guides/autonomy-guards-reference.md)
